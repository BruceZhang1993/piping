...
public class ProcessManager {
     ...
     */
    public static boolean isMyProcessInTheForeground(Context ctx) {
        List<AndroidAppProcess> processes = getRunningAppProcesses(ctx);
     ...
     * {@link #getRunningAppProcesses(Context ctx)} or {@link android.app.usage.UsageStatsManager}</p>
     *
     * @param ctx the application context
    ...
    public static void killProcess(Context context, String value) {
        ActivityManager am = (ActivityManager) context.getSystemService(Activity.ACTIVITY_SERVICE);
