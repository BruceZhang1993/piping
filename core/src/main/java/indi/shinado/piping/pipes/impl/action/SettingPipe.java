...
//        StringBuilder instruction = new StringBuilder("Please select an item. Enter any other keys to quit. \n");
//        int i=0;
//        if (getLauncher() instanceof IBase){
//            instruction.append(i++).append(".set wallpaper\n");
//        }
//        if (getLauncher() instanceof IText){
//            instruction.append(i++).append(".set text color\n");
//            instruction.append(i++).append(".set text size\n");
//            instruction.append(i++).append(".set head text\n");
//            instruction.append(i++).append(".set boundary width\n");
//        }
//        if (getLauncher() instanceof IAnimation){
//            instruction.append(i++).append(".set animation\n");
//        }
//        if (getLauncher() instanceof IAnimation){
//            instruction.append(i).append(".set shift key\n");
//        }
//
//        callback.onOutput(instruction.toString());
