...
public class HelpPipe extends DefaultInputActionPipe{
    ...
    private void help(OutputCallback callback){
        StringBuilder sb = new StringBuilder("Simply search your application or contact.\n")
                .append("To switch results, tap MENU button.\n")
                .append("If you do not have MENU button in your phone, please try enter '$setting' to set shift key.\n")
                .append("To display history or intercept an action, tap BACK button.\n")
